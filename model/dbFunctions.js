            ...
            if (existingUsers === 0) {
                const sampleUsers = [
                    ...
                    },
                    {
                        ...
                        profileImage: "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/ca4244a3-4ba1-4186-809b-31a4358d3605/desdu2p-4a865ea7-3507-438e-9d95-ad71d33cb88b.png/v1/fill/w_894,h_894,q_70,strp/new_pfp_by_pokerfacedartist_desdu2p-pre.jpg",
        ...
        try {
            ...
            if (existingPosts === 0) {
                ...
                samplePosts = [
                    ...
                    {
                        _id: new ObjectId("67cd7021b8b17b78e305942c"),
                        forumId: new ObjectId("67c7b80a8f936822ab9178a3"),
                        authorId: new ObjectId("67c792cfb3ba6d9c76f699d5"),
                        title: "zx",
                        content: "zx",
